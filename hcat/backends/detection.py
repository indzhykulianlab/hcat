...
class custom_FasterRCNN(GeneralizedRCNN):
    """
    ...
    def __init__(self, backbone, num_classes=None,
        ...
        super(custom_FasterRCNN, self).__init__(backbone, rpn, roi_heads, transform)
...
def fasterrcnn_generic_fpn(architecture_name: str, pretrained=False, progress=True,
                             num_classes=3, pretrained_backbone=True, trainable_backbone_layers=None, **kwargs):
    """
    Modification of fasterrcnn_resnet50_fpn from torchvision.models.deteciton.faster_rcnn

    Args:
        architecture_name (str): a valid name from above
    ...
    backbone = resnet_fpn_backbone(architecture_name, pretrained, trainable_layers=trainable_backbone_layers)
    model = custom_FasterRCNN(backbone, num_classes, min_size=152, max_size=512)
