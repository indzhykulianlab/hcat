...
This gui comes with two important new features - 1. The ability to correct poor model detections and 2. the ability to perform automated detection on multi piece dissections!

To download a copy of the user manual, see here: [User Manual](https://www.dropbox.com/scl/fi/eomc3gujrmm4u4enavjo0/hcat_user_manual.pdf?rlkey=l54z2opwvbovu1tp0i6cmh6ht&dl=1)

To see a quick screen recording of the workflow, please see here: [Video Here](https://www.youtube.com/watch?v=Mg8hi8yBqoA)
